...
void GameOver(){
	iClear();
		...
		iText(10, 10, "press 'End' to exit.");
			...
			iRectangle(300, 400-50-100-200, 250, 30);

		//drawTextBox();
		if(mode == 1)
		{
			iSetColor(255, 255, 255);
			iText(305, 400-50+10-100-200, str);
		}
...
void iMouse(int button, int state, int mx, int my){
	...
	if(mx>=325+100 && mx<=525+100 && my>=320-200 && my<=360-200 && tru == 0){
		...
		if(mx >= 295 && mx <= 295+250 && my >= 400-50-100-200 && my <= 400-50+50-100-200 && mode == 0)
		{
			mode = 1;
		}
		}
